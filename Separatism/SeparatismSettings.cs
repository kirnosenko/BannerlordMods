...
namespace Separatism
{
	public class SeparatismSettings : AttributeGlobalSettings<SeparatismSettings>, INotifyPropertyChanged
	{
		...
		[SettingPropertyGroup("{=Separatism_Settings_900}Anarchy rebellions", GroupOrder = 1)]
		...
		[SettingPropertyGroup("{=Separatism_Settings_200}Relation thresholds", GroupOrder = 4)]
		...
		[SettingPropertyGroup("{=Separatism_Settings_600}Banners", GroupOrder = 7)]
