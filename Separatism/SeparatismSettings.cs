...
namespace Separatism
{
	public class SeparatismSettings : AttributeSettings<SeparatismSettings>, INotifyPropertyChanged
	{
		...
		[SettingPropertyGroup("{=Separatism_Settings_100}Lord rebellions", 0, true)]
		...
		[SettingPropertyGroup("{=Separatism_Settings_100}Lord rebellions", 0)]
		...
		public int SettlementRebellionStartLoyaltyThreshold
		{
			...
			set
			{
				...
				if (settlementRebellionStartLoyaltyThreshold > settlementRebellionEndLoyaltyThreshold)
				{
					...
					PropertyChanged(this, new PropertyChangedEventArgs(nameof(settlementRebellionEndLoyaltyThreshold)));
				}
			}
		}
		...
		public int SettlementRebellionEndLoyaltyThreshold
		{
			...
			set
			{
				...
				{
					settlementRebellionStartLoyaltyThreshold = value;
					PropertyChanged(this, new PropertyChangedEventArgs(nameof(settlementRebellionStartLoyaltyThreshold)));
				}
			}
		}

		[SettingPropertyGroup("{=Separatism_Settings_200}Relation thresholds", 2)]
		...
		[SettingPropertyGroup("{=Separatism_Settings_300}Relation changes", 3)]
		...
		[SettingPropertyGroup("{=Separatism_Settings_500}Politics", 4)]
		...
		[SettingPropertyGroup("{=Separatism_Settings_600}Banners", 5)]
